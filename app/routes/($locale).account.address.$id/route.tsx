...
import type { AccountOutletContext } from "../($locale).account.edit/route"
        ...
        <Form method="post">
          ...
          <div className="mt-4">
            <input
              ...
              className="cursor-pointer rounded-sm border-1 border-gray-500"
            />
            <label
          ...
          <div>
            <Button
              to=".."
              className="mt-2 w-full rounded focus:shadow-outline"
              variant="secondary"
            >
              Cancel
            </Button>
