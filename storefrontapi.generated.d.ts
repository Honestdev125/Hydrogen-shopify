...
export type ProductCardFragment = Pick<
  ...
  'id' | 'title' | 'publishedAt' | 'handle' | 'vendor' | 'productType'
> & {
  variants: {
    nodes: Array<
      Pick<
  ...
  process?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'id' | 'value'>>;
  scene?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'id' | 'value'>>;
  ...
  products: {
    nodes: Array<
      ...
      > & {
        ...
        process?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'id' | 'value'>
        >;
        scene?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'id' | 'value'>
        >;
        options: Array<
